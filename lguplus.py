...
time.sleep(5.0)
"""
print("Activation of dimmers. Number of Nodes in the network",len(network.nodes))
for node in network.nodes:
    network.nodes[node].neighbor_update()
    time.sleep(3.0)
...
#network.manager.resetController(0xe618f954)
